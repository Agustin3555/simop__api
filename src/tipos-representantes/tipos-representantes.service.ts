...
export class TiposRepresentantesService {
  ...
  async getOne(id: number) {
    ...
    return await prisma.tipoRepresentante.findUnique({
      where: { id },
    })
  }
  ...
  async getRefs() {
    ...
    return await prisma.tipoRepresentante.findMany(tipoSelectRef)
  }
  ...
  async updateOne(id: number, data: UpdateDto) {
    ...
    return await prisma.tipoRepresentante.update({ where: { id }, data })
  }
